...
enum saakm_state {
	...
	SAAKM_TERMINATED,
	/*
	 * A special state that is equivalent to SAAKM_READY, but makes it
...
saakm_state_to_str(const enum saakm_state s)
{
	switch (s) {
	case SAAKM_NOT_QUEUED:
		return "SAAKM_NOT_QUEUED";
	case SAAKM_MIGRATING:
		return "SAAKM_MIGRATING";
	case SAAKM_RUNNING:
		return "SAAKM_RUNNING";
	case SAAKM_READY:
		return "SAAKM_READY";
	case SAAKM_BLOCKED:
		return "SAAKM_BLOCKED";
	case SAAKM_TERMINATED:
		return "SAAKM_TERMINATED";
	case SAAKM_READY_TICK:
		return "SAAKM_READY_TICK";
	}
